...
ALLOWED_COMMANDS="/usr/bin/systemctl start *, /usr/bin/systemctl stop *, /usr/bin/systemctl restart *, /usr/bin/systemctl status *, /usr/bin/journalctl -f *, /usr/bin/journalctl -u *, /usr/sbin/reboot, /usr/sbin/poweroff, /usr/bin/systemctl suspend, /usr/bin/firewall-cmd *, /usr/sbin/ufw *, /usr/sbin/setenforce *, /usr/sbin/getenforce, /usr/sbin/sestatus"
