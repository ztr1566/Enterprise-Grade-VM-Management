...
- 001-vm-management: Added Go (Golang) v1.21+, TypeScript (Strict) + React, Tailwind CSS, xterm.js (Frontend) / gorilla/websocket, golang.org/x/crypto/ssh, mattn/go-sqlite3 (Backend)
